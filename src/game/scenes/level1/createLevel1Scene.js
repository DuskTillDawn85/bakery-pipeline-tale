...
import { createLevel1InboxItems } from '../../levels/level1/level1Items'
...
export function createLevel1Scene(ctx) {
  ...
  inboxBelt.group.position.set(-2.9, 0, 0)
  ...
  outboxBelt.group.position.set(2.9, 0, 0)
  ...
  const initialInbox = createLevel1InboxItems()
  ...
  function moveWorkerTo(target, duration = 0.55) {
  ...
  async function doInbox() {
    ...
    pickup.x -= 0.45
    await moveWorkerTo(pickup, 0.55)
